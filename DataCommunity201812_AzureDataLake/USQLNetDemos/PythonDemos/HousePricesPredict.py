...
COLUMN_ID = 'Id'
COLUMN_Y = 'SalePrice'
dir_name = 'd:\\Repos\\Cloud4YourData\\CommunityEvents\\DataCommunity201812_AzureDataLake\\USQLNetDemos\\Misc\DS\\'
...
data_test_id, data_test_x  = prepare_data(df.head())
#data_test_id, data_test_x = load_data(dir_name + '\\test.csv')
#print(data_test_x.dtypes)

model = joblib.load(dir_name + '\\housePricesModel.pkl')
predvalues = predict(model, data_test_id, data_test_x)
print(list(predvalues))
print(predvalues.head())
