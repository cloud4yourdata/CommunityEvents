...
CREATE OR REPLACE VIEW vwStreetCrimesExt
 ...
 WHERE VALUE:c2 IS NOT NULL AND VALUE:c6 IS NOT NULL AND VALUE:c7 IS NOT NULL;
 
 
 ---SHOW DATA and SHOW PLAN
 SELECT * FROM vwStreetCrimesExt WHERE date_part=to_date('2017-07-01','YYYY-MM-DD') LIMIT 14;
